...
# with command line options: MinBias_13TeV_pythia8_TuneCUETP8M1_cfi --conditions auto:run2_mc -n 10 --era Run2_2016 --eventcontent FEVTDEBUG --relval 9000,100 -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:@relval2016,RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --magField 38T_PostLS1 --beamspot NominalCollision2015 --eventcontent RECOSIM
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_13TeV_pythia8_TuneCUETP8M1_cfi_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_RECO.root'),
