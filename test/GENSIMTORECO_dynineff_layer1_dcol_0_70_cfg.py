...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/data/store/mc/RunIISummer15GS/MinBias_TuneCUETP8M1_13TeV-pythia8/GEN-SIM/MCRUN2_71_V1-v2/10000/004CC894-4877-E511-A11E-0025905C3DF8.root'),
...
process.RECOSIMoutput.outputCommands += cms.untracked.vstring("keep *_simSiPixelDigis_*_*")
# process.RECOSIMoutput.outputCommands += cms.untracked.vstring("keep *_*_dcolLostNeighbourDigiFlags_*")

# Other statements
process.mix.input.fileNames = cms.untracked.vstring(['file:/data/store/mc/RunIISummer15GS/MinBias_TuneCUETP8M1_13TeV-pythia8/GEN-SIM/MCRUN2_71_V1-v2/10002/082C3FE4-7479-E511-BCC5-0025904C8254.root'])
...
if useSqlite:
    ...
    process.DynIneffDBSource = cms.ESSource("PoolDBESSource",
        CondDBSetup,
        connect = cms.string('sqlite_file:dynIneffDB_dcol70.db'),
